-- =====================================================
-- Mega Automação v2 — Galeria, Perfis, Fontes
-- =====================================================

-- 1. Bucket de mídia (uploads do usuário)
...
create table if not exists public.creations (
  ...
  type text not null default 'image', -- image, video, carousel
  urls text[] not null default '{}',
  thumbnail_url text,
  prompt text,
  template_id text,
  template_name text,
  source_id text, -- referência à fonte usada
